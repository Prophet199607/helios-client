...
<template>
  <nav class="bg-blue-500 text-white py-4">
    <div class="container mx-auto flex justify-between items-center">
      <!-- Logo -->
      <a href="#" class="text-xl font-bold">Helios</a>
      <!-- Menu -->
      <ul class="flex items-center space-x-6">
        ...
        <li v-if="auth.user" >
          <div class="block relative" x-data="{showChildren:false}" x-on:click.away="showChildren=false">
            ...
            <div
                class="bg-white shadow-md text-gray-800 rounded border border-gray-300 text-sm absolute top-auto right-0 min-w-full w-56 z-30 mt-1"
                ...
                <ul class="list-reset">
                  <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false"
                    ...
                    <router-link :to="{name: 'dashboard'}"
                      ...
                      <span class="flex-1">Profile</span> </router-link>
                  </li>
                  <li class="relative" x-data="{showChildren:false}" @mouseleave="showChildren=false"
                      @mouseenter="showChildren=true">
                    <a href="#"
